...
@Service
public class RiderAcknowledgementNotificationService {
    ...
    private static final String ACKNOWLEDGEMENT_OPENED_NOTIFICATION_TYPE =
        "RIDER_ACKNOWLEDGEMENT_OPENED";

    private static final String ACKNOWLEDGEMENT_REMINDER_NOTIFICATION_TYPE =
    ...
    public RiderAcknowledgementNotificationService(
    ...
    public void publishOpened(
        Long assignmentId
    ) {
        publishNotification(
            assignmentId
            , ACKNOWLEDGEMENT_OPENED_NOTIFICATION_TYPE
            , null
        );
    }
    ...
    public void publishReminder(
        ...
        publishNotification(
            assignmentId
            , ACKNOWLEDGEMENT_REMINDER_NOTIFICATION_TYPE
            , reminderStage
        );
    }
    ...
    private void publishNotification(
        ...
        OffsetDateTime responseDeadline =
            assignment.getDeliveryGroup()
                .getDeliveryDate()
                .atTime(
                    DeliveryAssignmentAcknowledgementTime.getResponseDeadline(
                        assignment.getDeliveryGroup()
                            .getSlot()
                            .getCode()
                    )
        ...
        DeliveryOperationNotificationData data =
            new DeliveryOperationNotificationData(
                ...
                .name()
                , businessKey
                , getReminderStageName(reminderStage)
                , null
                , responseDeadline
            );
    ...
    private String getBusinessKey(
        ...
        if (reminderStage == null) {
            return DeliveryOperationNotificationBusinessKey.riderAcknowledgementOpened(
                assignmentId
            );
        }

        return DeliveryOperationNotificationBusinessKey.riderAcknowledgementReminder(
            assignmentId
            , reminderStage.name()
        );
    }

    private String getReminderStageName(
        DeliveryAssignmentAcknowledgementReminderStage reminderStage
    ) {
        if (reminderStage == null) {
            return null;
